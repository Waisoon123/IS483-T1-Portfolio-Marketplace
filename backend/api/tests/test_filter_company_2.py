...
TEST_CASES_DICT = {
    ...
    "Valid Filter Both Filter": {"tech_sector_field": TECH_SECTOR, "value_tech_sector_field": 1, "hq_main_office_field": HQ_MAIN_OFFICE, "value_hq_main_office_field": 2, "expected_response_status_code": status.HTTP_200_OK,"count": 1},
    ...
    "Inalid Filter TechSector Does Not Exist": {"tech_sector_field": TECH_SECTOR, "value_tech_sector_field": 0, "hq_main_office_field": HQ_MAIN_OFFICE, "value_hq_main_office_field": 1, "expected_response_status_code": status.HTTP_200_OK, "count": 0},
    "Inalid Filter MainOffice Does Not Exist": {"tech_sector_field": TECH_SECTOR, "value_tech_sector_field": 2, "hq_main_office_field": HQ_MAIN_OFFICE, "value_hq_main_office_field": 0, "expected_response_status_code": status.HTTP_200_OK, "count": 0},
    "Inalid Filter TechSector & MainOffice Do Not Exist": {"tech_sector_field": TECH_SECTOR, "value_tech_sector_field": 0, "hq_main_office_field": HQ_MAIN_OFFICE, "value_hq_main_office_field": 0, "expected_response_status_code": status.HTTP_200_OK, "count": 0},
}
