...
TEST_CASES_DICT = {
    ...
    "Create User with Empty Interests": {"field": INTERESTS, "value": "[]", "expected_response_status_code": status.HTTP_400_BAD_REQUEST, "expected_response": {"interests": ["Interests cannot be empty. Please enter at least one interest."]}},
